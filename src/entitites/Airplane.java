...
public class Airplane extends Entity {
     ...
     * //Thrust
     * <p>
     * //The Velocity of Air Exiting The Engine
     * float propellerVelocity=0;
     * <p>
     * //air density
     * <p>
     * //The Area of Air which it Captured by the Engine
     * final float EngineArea=0;
     * <p>
     * //Air Velocity in General
     * final float AirVelocity=0;
     * <p>
     * float ThrustForceValue=(rho *AirVelocity*EngineArea)*(propellerVelocity-AirVelocity) ;
     */
    ...
    public   void   InitializeAirplane() {
        ...
        iPitch = 0.0f;
        iYaw   = 0.0f;
        Orientation=Orientation.MakeQFromEulerAngles(iRoll, iPitch, iYaw);
    ...
    private  void   CalculateElementCGCoords() {
        for (int i = 0; i< 8; i++)
        {
            MathVector EPosition= AirplaneElements[i].Position;
            EPosition.Sub(CG);
    ...
    private void   CalcAirplaneLoads(){
        ...
        for(int i=0;i<8;i++)
        {
            ...
            //v=v+w*r
            Velocity = this.VelocityBody.copy();
            Velocity.Add(vtmp);

            // Calculate local air speed

            LocalSpeed = Velocity.Magnitude();
        ...
        MathVector Weight=new MathVector(0,0,g * this.AirplaneMass);
